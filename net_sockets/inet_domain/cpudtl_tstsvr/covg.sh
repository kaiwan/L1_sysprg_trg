...
# Rationale:
# As a program/server under test can run continually, we will have to manually run
# the coverage utils.
# Attempting to abort the program with ^C (or [p]kill) causes the entire chain
